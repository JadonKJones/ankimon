...
def install(app, user_path, real_webengine=False):
    ...
    if web_view is None:
        ...
        # Mock PyQt6.QtWebEngineWidgets and PyQt6.QtWebEngineCore to prevent import errors in other modules
        widgets_mod = ModuleType("PyQt6.QtWebEngineWidgets")
        widgets_mod.QWebEngineView = web_view
        sys.modules["PyQt6.QtWebEngineWidgets"] = widgets_mod

        core_mod = ModuleType("PyQt6.QtWebEngineCore")
        core_mod.QWebEnginePage = web_page
        core_mod.QWebEngineSettings = web_settings
